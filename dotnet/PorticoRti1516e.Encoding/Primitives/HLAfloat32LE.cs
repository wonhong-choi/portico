...
{
    // 4-byte little-endian IEEE-754 single. Port of HLA1516eFloat32LE (Java).
    public sealed class HLAfloat32LE : DataElementBase
    {
        ...
        public override void Encode(ByteWrapper byteWrapper)
        {
            ...
            BitHelpers.PutFloatLE(_value, bytes, 0);
        ...
        public override void Decode(ByteWrapper byteWrapper)
        {
            ...
            _value = BitHelpers.GetFloatLE(bytes, 0);
        }
    }
}
